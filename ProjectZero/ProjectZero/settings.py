...
SECRET_KEY = 'django-insecure-(@axh-!2u59l!t66d!e&e5drk8&@*_+2jgv$*6*!7f%b&2@63n'
...
INSTALLED_APPS = [
    ...
    #the below is responsible for attaching static files
...
# To Tell django to check other static directories also
STATICFILES_DIRS = [
    BASE_DIR /  "static"
]
